...
public class RecipeServer {
    ...
    public static String fetchData(String foodQuery, int numRecipes, int offset) {
            ...
            try {
                    String sUrl = "https://spoonacular-recipe-food-nutrition-v1.p.mashape.com/recipes/searchComplex?limitLicense=false&number=" + numRecipes  + "&offset=" + offset + "&query=" + foodQuery + "&ranking=1&mashape-key=mP7f87A8jCmshXEEX8fWwtLskVSup1rHVURjsnkUd09UtPgq4v";
